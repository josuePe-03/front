      ...
      <div className="w-full sm:pl-[3rem] pt-[2rem] sm:pt-0 ">
        <div className="px-12 pt-4  ">
          ...
          <section className="h-[85vh] ">
            <div class="">
              {/* <!-- Start coding here --> */}
              <div class="bg-white w-fit dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="w-full overflow-x-auto h-[22rem]">
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <TrUbicacion />
                    </thead>
                    <tbody>
                      {ubicaciones === "Sin equipos existentes" ? (
                        <tr>
